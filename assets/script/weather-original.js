					...
					if(data != null && data.query.results != null) {
						$.each(data.query.results, function(i, result) {
							...
							var weather = {					
								...
								thumbnail: "https://l.yimg.com/a/i/us/nws/weather/gr/"+result.item.condition.code+timeOfDay+"s.png",
								image: "https://l.yimg.com/a/i/us/nws/weather/gr/"+result.item.condition.code+timeOfDay+".png",
								tomorrow:{
									...
									image: "https://l.yimg.com/a/i/us/nws/weather/gr/"+result.item.forecast[1].code+"d.png"
								},
